...
public interface WeeklyPlanService {
    ...
    WeeklyPlan createWeeklyPlan(int wid,String name, String email) throws SQLException;
    WeeklyPlan updateWeeklyPlan(int wid, String name, String email) throws SQLException;
